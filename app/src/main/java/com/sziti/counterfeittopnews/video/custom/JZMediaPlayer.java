package com.sziti.counterfeittopnews.video.custom;
...
import com.sziti.counterfeittopnews.video.base.JZMediaInterface;
import com.sziti.counterfeittopnews.video.base.JZMediaManager;
import com.sziti.counterfeittopnews.video.base.JzvdMgr;
...
public class JZMediaPlayer extends JZMediaInterface implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public void prepare() {
        try {
            ...
            mediaPlayer.setOnPreparedListener(JZMediaPlayer.this);
            mediaPlayer.setOnCompletionListener(JZMediaPlayer.this);
            mediaPlayer.setOnBufferingUpdateListener(JZMediaPlayer.this);
            mediaPlayer.setScreenOnWhilePlaying(true);
            mediaPlayer.setOnSeekCompleteListener(JZMediaPlayer.this);
            mediaPlayer.setOnErrorListener(JZMediaPlayer.this);
            mediaPlayer.setOnInfoListener(JZMediaPlayer.this);
            mediaPlayer.setOnVideoSizeChangedListener(JZMediaPlayer.this);
